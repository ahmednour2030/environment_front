...
export default {
  pages: {
    ...
    data: [
      ...
      { title: 'Users Edit', route: { name: 'apps-students-edit', params: { id: 21 } }, icon: 'UserIcon', isBookmarked: false },
      { title: 'Users List', route: { name: 'apps-students-list' }, icon: 'UserIcon', isBookmarked: false },
      { title: 'Users View', route: { name: 'apps-students-view', params: { id: 21 } }, icon: 'UserIcon', isBookmarked: false },

            ...
            <b-row>
              ...
              >
                ...
                <small class="text-muted">
                  من فضلك قم بادخال بيانات الشركة.
                </small>
              </b-col>
              <b-col md="4">
                <b-form-group
          ...
          >
            <b-row>
              ...
              >
                ...
                <small
                  class="text-muted"
                >استكمال البيانات وكتابة بيانات الشركة.</small>
              </b-col>
              <b-col md="3">
                <b-form-group
...
const dic = {
  ar: {
    names: {
      ...
      commercial_register: 'سجل الشركة',
      commercial_register_image: 'صورة سجل الشركة',

...
export default {
  ...
  computed: {
    ...
    getCoupons() { return this.$store.state.question.question },
  },
  created() {
    this.$store.dispatch('question/fetchByExam', this.$route.params.id).then(res => {
  ...
  methods: {
    ...
    editPage(id) {
      this.$router.push(`/edit-questions/${id}`)
    },
    confirmDelete(id) {
      this.$swal({
        title: 'حذف الكوبون',
